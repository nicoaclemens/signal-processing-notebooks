# used by: utils\audioclassifier\model.py, utils\audioclassifier\train.py
import torch
...
class FusionHead(nn.Module):
    def __init__(
        self, stft_embed_dim=256, env_embed_dim=128, output_dim=EMBED_DIM, dropout=0.3
    ):
        super().__init__()
