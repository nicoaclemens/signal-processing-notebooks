# used by: utils\audioclassifier\train.py
import torch
import torch.nn as nn
import torch.nn.functional as f
import numpy as np
from utils.audioclassifier.preprocessor import AudioPreprocessor
...
class AudioClassifier(nn.Module):
    ...
    def __init__(self, input_dim=256, n_classes=10):
        ...
        self.block1 = ResidualBlock(
            in_dim=256, hidden_dim=512, out_dim=256, dropout=0.3
        )
        self.block2 = ResidualBlock(
            in_dim=256, hidden_dim=256, out_dim=128, dropout=0.2
        )
