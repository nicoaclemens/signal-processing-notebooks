# used by: cells\filter_chain\processing.py, cells\filter_chain\ui.py, cells\play_audio_custom_wave.py, cells\play_audio_multiplication.py, cells\synthesizer.py
import numpy as np
